<template>
  <div class="min-h-screen bg-white flex flex-col justify-center py-12 sm:px-6 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
      <div class="ml-6"><img src="../assets/safebites_logo.png"></div>
    ...
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
      <div class="bg-white py-8 px-4 shadow sm:rounded-xl sm:px-10">
        <form class="space-y-6" @submit.prevent="handleSubmit">
          <div v-if="!isLogin">
            <label for="family_name" class="block text-sm font-medium text-gray-700 font-agatholightmin">Last
              Name</label>
            <div class="mt-1">
          ...
          <div v-if="!isLogin">
            <label for="name" class="block text-sm font-medium text-gray-700 font-agatholightmin">First Name</label>
            <div class="mt-1">
          ...
          <div v-if="!isLogin">
            <label for="user_name" class="block text-sm font-medium text-gray-700 font-agatholightmin">Username</label>
            <div class="mt-1">
          ...
          <div>
            <label for="email" class="block text-sm font-medium text-gray-700 font-agatholightmin">Email address</label>
            <div class="mt-1">
          ...
          <div>
            <label for="password" class="block text-sm font-medium text-gray-700 font-agatholightmin">Password</label>
            <div class="mt-1">
          ...
          <div v-if="!isLogin">
            <label for="confirmPassword" class="block text-sm font-medium text-gray-700 font-agatholightmin">Confirm
              Password</label>
            <div class="mt-1">
...
export default {
  ...
  methods: {
    ...
    async handleSubmit() {
      ...
      if (!this.email || !this.password || !this.user_name || !this.name || !this.family_name) {
      ...
      try {
        const authData = {
          ...
          user_type: false // Imposta il tipo di utente se necessario
        };
        ...
        if (this.isLogin) {
          ...
          const response = await axios.post('http://localhost:8000/api/v1/users', authData);
