<template>
    <div class="min-h-screen bg-gray-50">
        ...
        <div class="flex mt-14 items-center justify-center mx-auto">
            <p class= "text-red-600 font-oooh text-6xl">I piatti della Tradizione trentina:</p>
        </div>
        <div class="flex flex-wrap justify-start items-start gap-16 p-20 -mt-6">
            <FoodTraditionCard />
            <FoodTraditionCard />
            <FoodTraditionCard />
            <FoodTraditionCard />
...
<script setup>
import FoodTraditionCard from './FoodTraditionCard.vue';
